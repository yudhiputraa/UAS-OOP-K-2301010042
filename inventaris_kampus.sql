...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 26 Jun 2025 pada 12.57
...
CREATE TABLE `barang` (
  ...
  `kondisi` enum('Baik','Rusak','Perlu Servis','') NOT NULL,
...
INSERT INTO `barang` (`id_barang`, `nama_barang`, `jumlah`, `kondisi`, `id_ruangan`) VALUES
(4, 'Kursi', 15, 'Baik', 1),
(5, 'TV', 2, 'Rusak', 10),
(6, 'Meja', 1, 'Perlu Servis', 2),
(8, 'Proyektor', 1, 'Baik', 3);
